  ...
  Client.prototype.onMessage = function(message) {
    ...
    switch (message.type) {
      ...
      case "message":
        ...
        if (channel) {
			var resultFromMessageAdded = channel.addMessage(m);			
          return resultFromMessageAdded;
        }
        break;
	  case "file_comment_added":
		console.log("file_comment_added event on client");
		return this.emit('file_comment_added', message);		
	    break;
      case "channel_marked":
      case "im_marked":
      case "group_marked":
